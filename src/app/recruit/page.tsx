            ...
            <form onSubmit={handleSubmit} className="space-y-6 text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-1.5">
                  <label className="block text-[11px] font-bold uppercase text-slate-300">Full Name *</label>
                  <input
                    type="text"
                    name="name"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="block text-[11px] font-bold uppercase text-slate-300">DSU / Personal Email *</label>
                  <input
                    type="email"
                    name="email"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="block text-[11px] font-bold uppercase text-slate-300">WhatsApp / Phone *</label>
                  <input
                    type="tel"
                    name="phone"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="block text-[11px] font-bold uppercase text-slate-300">Academic Year *</label>
                  <select
                    name="year"
                    value={formData.year}
                    onChange={handleChange}
                ...
                <div className="space-y-1.5">
                  <label className="block text-[11px] font-bold uppercase text-slate-300">Branch / Department *</label>
                  <input
                    type="text"
                    name="branch"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="block text-[11px] font-bold uppercase text-slate-300">Preferred Wing *</label>
                  <select
                    name="preferredTeam"
              ...
              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold uppercase text-slate-300">Core Technical / Non-Technical Skills *</label>
                <input
                  type="text"
                  name="skills"
                  required
              ...
              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold uppercase text-slate-300">GitHub / Portfolio / LinkedIn URL</label>
                <input
                  type="url"
                  name="portfolioUrl"
              ...
              <div className="space-y-1.5">
                <label className="block text-[11px] font-bold uppercase text-slate-300">Why do you want to join AI Foundry? *</label>
                <textarea
                  rows={4}
                  name="whyJoin"
                  required
