  ...
  return (
    <div className="mesh-bg min-h-screen pt-36 sm:pt-44 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="glass-card rounded-3xl p-6 sm:p-8 h-80 bg-white/60 animate-pulse border border-white/80" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="glass-card rounded-3xl p-6 h-96 bg-white/60 animate-pulse border border-white/80"
            />
          ))}
        </div>
      </div>
